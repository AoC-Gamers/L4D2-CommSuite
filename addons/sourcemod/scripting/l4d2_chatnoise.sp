...
#define L4D2_CHATNOISE_VERSION "0.3.0"
...
{
	g_cvLogMode = L4D2CS_FindOrCreatePluginLogModeConVar("l4d2_chatnoise_log_mode", "L4D2 ChatNoise log mode. 0=off, 1=normal, 2=debug.");
